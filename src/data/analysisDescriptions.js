...
const descriptions = {
  ...
  "ga-hb463": "Hypothetical multi-year analysis of Georgia HB463 assuming all revenue triggers are met. Compared against a triggered baseline (5.09% in 2026, 4.99% floor in 2027+), HB463 reduces rates from 4.99% (2026) to 3.99% (2034), increases standard deductions ($15K/$30K to $18K/$36K single/joint), raises the dependent exemption ($5K to $6K), and increases the retirement exclusion for 65+ to $70K. 9-year revenue impact: -$37B. Excludes tips/overtime exemptions and credit repeals.",
